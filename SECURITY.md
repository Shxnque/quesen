...
- Steps to reproduce (against `https://web-production-3df26.up.railway.app`
...
- The production API at `https://web-production-3df26.up.railway.app`.
- The MCP endpoint at `https://web-production-3df26.up.railway.app/mcp`.
